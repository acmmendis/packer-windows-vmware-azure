...
Configuration CIS_WindowsServer {
   param (
   ...
   Node $NodeName {
      ...
      #  2.2.48 (L1) Ensure 'Take ownership of files or other objects' is set to 'Administrators'
       ...
       SecurityOption AccountSecurityOptions {
         ...
         Accounts_Rename_administrator_account = 'User_Admin' # WARNING! Any value different from Administrator
         ...
         #Interactive_logon_Message_text_for_users_attempting_to_log_on = 'This computer system is the property of Avira Holding GmbH Co. KG and is for authorised use by employees and designated contractors only. By continuing to use this system you indicate your awareness of and consent to these terms and conditions of use.It is the users responsibility to LOG OFF IMMEDIATELY if you do not agree to the conditions stated in this notice.'
